...
sys.path.append(os.getcwd() + '/src/uav0/scripts/control/')
...
class UAV_ROS_Consensus:
    def __init__(self,
        ...
        self.uav_msg_1 = uav_msg()
        self.uav_msg_2 = uav_msg()
    ...
    def uav_msg_2_cb(self, msg: Bool):
        self.uav_msg_2 = msg
    ...
    def approaching(self):
        ...
        if ((np.linalg.norm(self.pos0 - self.pos) < 0.2) and  # 位置误差
            ...
            self.uav_msg_0.are_you_ok.data = False
            return True
        else:
            self.uav_msg_0.are_you_ok.data = True
            return False
