...
if __name__ == "__main__":
    ...
    oa = np.array(rospy.get_param('~oa_0')).astype(float)
    op = np.array(rospy.get_param('~op_0')).astype(float)
    oba = np.array(rospy.get_param('~oba_0')).astype(float)
    obp = np.array(rospy.get_param('~obp_0')).astype(float)
    '''define trajectory'''
