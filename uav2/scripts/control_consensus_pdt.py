...
if __name__ == "__main__":
    rospy.init_node("uav2_control_consensus_pdt")
    ...
    observer = pdt_do()
    observer.load_param_from_yaml('~uav2_pdt_do')
    ...
    while not rospy.is_shutdown():
        ...
        if uav_ros.global_flag == 1:  # approaching
            ...
            uav_ros.cal_Lambda_eta(dot2_eat_d=dot2_eta_d, dot2_nu=dot2_nu, obs=obs if t_now > 2 else np.zeros(3))
