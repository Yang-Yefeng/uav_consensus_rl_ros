...
if __name__ == "__main__":
    rospy.init_node("uav2_rl_param_opt")
    
    nn_input_state_sub = rospy.Subscriber("/uav2/nn_input_rl", Float32MultiArray, callback=uav_state_cb)
    param_pub = rospy.Publisher("/uav2/ctrl_param", Float32MultiArray, queue_size=10)
