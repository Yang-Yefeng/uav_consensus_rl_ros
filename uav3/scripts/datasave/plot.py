...
if __name__ == '__main__':
    ...
    controlData = pd.read_csv(path + 'uav1/control.csv', header=0).to_numpy()
    observeData = pd.read_csv(path + 'uav1/observe.csv', header=0).to_numpy()
    ref_cmdData = pd.read_csv(path + 'uav1/ref_cmd.csv', header=0).to_numpy()
    uav_stateData = pd.read_csv(path +'uav1/uav_state.csv', header=0).to_numpy()
